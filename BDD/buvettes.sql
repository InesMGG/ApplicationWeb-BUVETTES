...
(
  ...
  CONSTRAINT PK_Buvette PRIMARY KEY (idB)
...
CREATE TABLE EstOuverte (
  idB int(11) NOT NULL,
  idM int(11) NOT NULL,
  CONSTRAINT PK_EstOuverte PRIMARY KEY (idB,idM)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
--
...
CREATE TABLE EstPresent (
  ...
  CONSTRAINT PK_EstPresent PRIMARY KEY (idV,idB,idM)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
--
...
(
  ...
  CONSTRAINT PK_Matchs PRIMARY KEY (idM)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
--
...
CREATE TABLE Volontaire (
  ...
  age int(11) NOT NULL,
  CONSTRAINT PK_Volontaire PRIMARY KEY (idV)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
--
